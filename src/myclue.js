...
function selectRandom (myArray){
    ...
    let randomSelect = Math.floor(Math.random() * (maxIndex + 1));

    return myArray[randomSelect]
}
/* 
...
function revealMystery(obj){
    return `${obj.suspect.firstName} ${obj.suspect.lastName} killed Mr. Boddy using the ${obj.suspect.weapon} in the ${obj.suspect.room}!`
}